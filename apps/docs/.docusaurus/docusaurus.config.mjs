...
export default {
  ...
  "presets": [
    [
      "classic",
      {
        "docs": {
          "routeBasePath": "/",
          "sidebarPath": "/Users/huytran/Desktop/react-native-iconify/apps/docs/sidebars.ts",
          "editUrl": "https://github.com/react-native-iconify/react-native-iconify/tree/main/apps/docs/"
        },
        "blog": false,
        "theme": {
          "customCss": "/Users/huytran/Desktop/react-native-iconify/apps/docs/src/css/custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    ...
    "footer": {
      "style": "dark",
      "copyright": "Copyright © 2025 React Native Iconify",
      "links": []
    },
    "prism": {
      "theme": {
